                        ...
                        <form action="{{ route('user.login.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" class="form-control" value="vendor@gmail.com" id="email"
                                ...
                                <div>
                                    ...
                                    <div class="pass-wrapper">
                                        <input type="password" value="1234" name="password" class="form-control" id="create-password"
