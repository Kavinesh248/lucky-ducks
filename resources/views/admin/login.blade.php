              ...
              <div class="login-form">
                ...
                <form id="loginform" action="{{ route('admin.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="email" name="email" class="User Name" placeholder="{{ __('Type Email Address') }}" value="admin@gmail.com" required="" autofocus>
                    <i class="icofont-user-alt-5"></i>
                  </div>
                  <div class="form-input">
                    <input type="password" name="password" class="Password" placeholder="{{ __('Type Password') }}" value="1234">
