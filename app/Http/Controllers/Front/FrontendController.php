...
class FrontendController extends FrontBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['popular_products'] = Product::whereStatus(1)->wherePopular(1)
            ...
            ->orderby('id', 'desc')
            ->get();
        $data['featured_products'] = Product::whereStatus(1)->whereFeatured(1)
        ...
        $data['blogs'] = Blog::orderby('id','desc')->take(2)->get();
